...
public class B1_LyThuyet_OOP {
    ...
    public static void main(String[] args) {
        //Khai báo 1 thông tin của 1 sinh viên
        String ten,sdt,email;
        int namsinh;
        String input;
        boolean flag;
        
        //Khai báo 1 thông tin GiaoVien
        String tenGV,sdtGV,EmaiGv;
        int namsinhGV;
        
        //1. Khởi tạo 1 đối tượng
        int a;
        SinhVien sv1 = new SinhVien();//Khai báo 1 đối tượng và chỉ lưu được 1 thông của 1 sinh viên
        SinhVien sv2;
        sv2 = new SinhVien();
        ...
        //3. Sử dụng phương thức đối tượng
        sv1.inRaManHinh();
        sv2.inRaManHinh();

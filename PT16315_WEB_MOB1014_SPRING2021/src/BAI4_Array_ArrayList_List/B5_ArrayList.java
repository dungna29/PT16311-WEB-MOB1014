...
public class B5_ArrayList {
    ...
    public static void main(String[] args) {
        ...
        //      - ArrayList định kiểu
        ArrayList<Integer> arrLstKieuSoNguyen = new ArrayList<Integer>();
        ArrayList<Double> arrLstKieuSoThuc = new ArrayList<Double>();
        ArrayList<String> arrLstKieuChuoi = new ArrayList<String>();

        //2. Gán giá trị
        //      - ArrayList không định kiểu
        arrLstKhongDinhKieu.add(1);
        arrLstKhongDinhKieu.add("FPT POLY");
        arrLstKhongDinhKieu.add(8.6);
        arrLstKhongDinhKieu.add(true);
        arrLstKhongDinhKieu.add(0, 5);//Ghi đè giá trị tại vị trí
        ...
        //      - ArrayList định kiểu
        arrLstKieuChuoi.add("B");
        arrLstKieuChuoi.add("C");
        arrLstKieuChuoi.add("A");
